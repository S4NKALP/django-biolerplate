...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Django project setup tool", prog="django-init"
    )
    ...
    secret_parser.add_argument(
        "--count", type=int, default=3, help="Number of keys to generate"
    )
    secret_parser.add_argument(
...
def handle_secret_command(args: argparse.Namespace) -> None:
    ...
    try:
        from .secret_generator import display_secret_keys, generate_multiple_keys
