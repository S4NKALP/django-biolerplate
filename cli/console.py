...
class UIFormatter:
    ...
    def create_welcome_panel():
        ...
        welcome_text.append("\n\n")
        welcome_text.append("This tool will help you create a Django project with:\n", style=UIColors.MUTED)
        welcome_text.append("• Modern project structure with environment-specific settings\n", style=UIColors.MUTED)
        welcome_text.append("• Pre-configured REST API with JWT authentication\n", style=UIColors.MUTED)
        welcome_text.append("• Essential dependencies and utilities\n", style=UIColors.MUTED)
    ...
    def create_summary_panel(project_name: str, app_name: str, success: bool):
        ...
        if success:
            ...
            summary_text.append("1. Navigate to your project directory\n", style=UIColors.MUTED)
            summary_text.append("2. Set environment variables in .env file\n", style=UIColors.MUTED)
            summary_text.append("3. Run migrations: python manage.py migrate\n", style=UIColors.MUTED)
            summary_text.append("4. Create superuser: python manage.py createsuperuser\n", style=UIColors.MUTED)
            summary_text.append("5. Start development server: python manage.py runserver\n", style=UIColors.MUTED)
        else:
            ...
            summary_text.append("Please check the error messages above and try again.\n", style=UIColors.MUTED)
            summary_text.append("Make sure you have the necessary permissions and dependencies.\n", style=UIColors.MUTED)
